...
// Validate ../../app/api/resume-access/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/resume-access">> = Specific
  const handler = {} as typeof import("../../app/api/resume-access/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
