...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Large-Scale Educational Technology Platform. Implemented authentication and authorization using Devise + Pundit RBAC. Built payment workflows using Stripe APIs with webhook-based event handling. Implemented background processing using multi-threaded job execution. Automated deployments using CircleCI with blue-green deployment patterns on Heroku.",
  ...
  },
  {
    ...
    description:
      "Distributed B2B Marketplace Platform. Built marketplace ingestion pipelines using Nokogiri-based crawlers for external data sources. Implemented async workflows using Sidekiq + ActiveMQ for classification and enrichment pipelines. Automated deployments using Capistrano with AWS-based infrastructure.",
